...
//API to get user appointments for frontend user appointments page
...
const cancelAppointment = async (req, res) => {
  try {
    ...
    // Verify if the user is the owner of the appointment
...
//API to verify payment for appointment using razorpay
